    ...
    function queueFile(file) {
      ...
      function processFile(err, stats) {
        ...
        if(stats.isDirectory()) {
          ...
          if(self.options.recurse && self.options.recurse(fullFile)) {
      ...
      function emitContents(err, data) {
        ...
        self.push({filename: fullFile, data: data, write: true})
        self.total -= 1
